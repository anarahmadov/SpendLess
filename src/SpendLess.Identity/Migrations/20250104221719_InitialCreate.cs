    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationTokens", x => x.TokenString);
                    table.ForeignKey(
                        name: "FK_ApplicationTokens_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ahmadovanarr@gmail.com", "System", "Admin", "AQAAAAEAACcQAAAAEFU2GolFpBuZ2pV141yZI1SSuyf53Rs+abj4lHxvlJm2fN9ie0lbE14szvqxFKsI1A==", 1, 0, "system_admin" });
